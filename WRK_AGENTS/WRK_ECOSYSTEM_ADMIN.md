...
### ⏳ Pending (ยกมาจาก #2 หัก 2 ข้อที่ปิดแล้ว)
1. ร่าง ทก.6-1/6-3 + สัญญาจ้าง 3 คน (นฤสรณ์ 1 มิ.ย. 69 · ณัฏฐพล · ธีรภัทร 1 เม.ย. 69) + **หาช่างคนที่ 4**
2. [กินโควตา] อ่านสัญญาเช่า ถข6540/6541 (หน้า 2 ในไฟล์รถ) · ลำดับ งด.50 ในงบ 2568 · เลขสัญญาเช่าซื้อ 17 คัน
3. scheduled task DOC EXPIRY CHECKER ยัง save ไม่ผ่าน
4. รายการ 1 (นภ.5042) วันแล้วเสร็จในคำขอ 13/07/2568 vs หนังสือรับรอง 27/06/2568 — ยังไม่แก้
5. [แนวคิด] sector database ใน webapp — ติด PII

### 🔴 ความเสี่ยงอายุเอกสารที่เหลือ (หลังปิด DBD)
1. **วงเงินสินเชื่อ ธพว.2499/2569** ออก 26/05/2569 อายุ 90 วัน → ครบ ~24/08/2569 (วันนี้) · ถ้าโดนส่งคืนแก้ไขต้องขอใหม่
2. **1ตข 7104** ภาษีครบ 04/09/2569 (เร็วสุด) · รถบรรทุก 10 ล้อ 6 คัน 30/09/2569 · ถข 138 31/10/2569
3. ยังไม่รู้: พ.ร.บ. 21 คัน · วันสิ้นสุดสัญญาเช่า ถข6540/6541 · อายุทะเบียนชั้น 4 เดิม
